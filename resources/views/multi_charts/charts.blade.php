<x-app-layout>
    ...
    <div class="flex flex-col lg:flex-row gap-2 py-4 my-4">
        <div class="w-full h-custom-card-height flex flex-col items-center justify-center bg-light-tertiaryBg dark:bg-tertiaryBg rounded-lg shadow-lg p-10 text-center"></div>
        <div class="w-full h-custom-card-height flex flex-col items-center justify-center bg-light-tertiaryBg dark:bg-tertiaryBg rounded-lg shadow-lg p-10 text-center"></div>
        <div class="w-full h-custom-card-height flex flex-col items-center justify-center bg-light-tertiaryBg dark:bg-tertiaryBg rounded-lg shadow-lg p-10 text-center">
            <!-- Icon -->
